...
fun confirmSendFindingBanner(): BannerModel = BannerModel(
    ...
    description = "Firmado electrónicamente - Unidad Funcional de APH <unidad funcional>, en razón," +
            " de la obligación contractual \"7.22 elaborar y verificar el diligenciamiento de la " +
            "bitácora de estado de los elementos equipos biomédicos y de radiocomunicaciones y " +
            "demás que hacen parte de los vehículos de emergencia está\n" +
