...
class LoginViewModel @Inject constructor(
    ...
    private fun List<com.valkiria.uicomponents.components.body.BodyRowModel>.toVehicleCode() {
        code = filterIsInstance<com.valkiria.uicomponents.components.body.ChipUiModel>()
